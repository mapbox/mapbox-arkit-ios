Pod::Spec.new do |s|
  ...
  s.documentation_url = "https://mapbox.github.io/mapbox-arkit-ios/documentation/"
  ...
  # Dependencies must be installed manually in the client app until iOS 11 stabalizes and iOS 11 
  # PRs land!
